...
class Report extends FPDF
{
    ...
    const CLIENT_URL = 'http://localhost/Repositorio/Repositorio/sitio_privado/';
    ...
    */
    public function header()
    {
        ...
        $this->image('../../images/Zeladinha Sneakers Logo.jpg', 15, 15, 20);
        // Se ubica el título.
        $this->cell(20);
        ...
        $this->cell(166, 10, 'Fecha/Hora de apertura: ' . date('d-m-Y H:i:s'), 0, 1, 'C');
