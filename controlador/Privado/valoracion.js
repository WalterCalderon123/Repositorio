...
async function fillTable(form = null) {
    ...
    if (JSON.status) {
        ...
        JSON.dataset.forEach(row => {
            ...
            (row.estado_valoracion) ? icon = '<i class="fa-solid fa-check"></i>' : icon = '<i class="fa-sharp fa-regular fa-ban"></i>';
...
function openReport() {
    ...
    const PATH = new URL(`${SERVER_URL}reports/dashboard/valoracion.php`);
